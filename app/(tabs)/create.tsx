  ...
  return (
    <SafeAreaView className="flex-1 bg-poddy-bg" edges={["top"]}>
      ...
      <View className="flex-1 items-center justify-center px-8">
        ...
        <View
          className="w-full rounded-2xl border-2 border-dashed border-poddy-border items-center justify-center py-16 mb-8"
        >
          <View
            className="w-16 h-16 rounded-2xl bg-poddy-accent-soft items-center justify-center mb-4"
          >
        ...
        <View className="w-full flex-row items-center justify-between bg-poddy-surface border border-poddy-border rounded-xl px-4 py-3 mb-6">
          <View className="flex-row items-center">
            <Ionicons name="globe-outline" size={18} color="#888888" />
